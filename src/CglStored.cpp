...
/*
  ...
  the stored cuts. Any that are violated by more than the required violation
  will be copied into cs for return to the caller.
*/
...
/*
  Yet another attempt to graft on implication cuts from CglTreeProbingInfo.
  Why don't we just call probingInfo_.generateCuts()?
*/
  if (probingInfo_) {
...
void 
CglStored::addCut(double lb, double ub, int size,
...
//-------------------------------------------------------------------
/*
  This would be less dangerous as a method --- much easier to add some
  robustness and return an indication of failure. Failure in a constructor
  is just a bad thing, and reading a file is all too prone to failure.
  -- lh, 110223 --
*/
