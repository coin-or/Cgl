...
[![Build Status](https://travis-ci.org/coin-or/Cgl.svg?branch=stable/0.60)](https://travis-ci.org/coin-or/Cgl)

[![Build status](https://ci.appveyor.com/api/projects/status/bk1edpd41aws90cp/branch/stable/0.60?svg=true)](https://ci.appveyor.com/project/tkralphs/cgl-e24vn/branch/stable/0.60)
...
chmod u+x coinbrew
./coinbrew fetch Cgl@stable/0.60
./coinbrew build Cgl
```
